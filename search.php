...
$name=$_GET['name'];
$movies = $mysqli->query("SELECT * FROM movies where title='$name'");
// echo $name;
?>
...
<header class="masthead">
    <div class="container-fluid">
        ...
        <center>
            ...
            <h3 class="subtitle">Book a movie</h3>
            <input type="search" name="search" class="search"><input type="submit" value="Search"><br><br><br><br><br><br>
        </center>
        <div class="list">
            ...
            <div id="movies">
                ...
                <?php while ($row = mysqli_fetch_assoc($movies)) : ?>
                    <div class="movie-item">
                        ...
                        <div class="mov-det">
                            <?php echo '<a class="btnBOOK" href="book.php?id=' . $movie['id'] . '"> BOOK A SEAT </a>' ?>
                        </div>
                    </div>
                <?php endwhile;
                ?>
